      ...
      *****************************************************************
       ...
       FILE-CONTROL.
           SELECT ENTRADA            ASSIGN TO DISK
                             'C:\Users\POSA-119\Downloads\CLIENTES.DAT'
                                       ORGANIZATION IS LINE SEQUENTIAL
                                       FILE STATUS IS WSS-FS-ENTRADA.

           SELECT SALIDA               ASSIGN TO DISK
                     'C:\Users\POSA-119\Downloads\CLIENTES.TXT'
                                       ORGANIZATION IS LINE SEQUENTIAL
       ...
       01 SWITCHES.
         ...
         77 WSV-IMP-TOTAL              PIC 9(08)    VALUE 0.
           ...
           READ ENTRADA
              EVALUATE TRUE
                 WHEN WSS-FS-ENTRADA-OK
                      ...
                      COMPUTE WSV-IMP-TOTAL=WSV-IMP-TOTAL+
                                            WSV-SALIDA-IMPORTE
                      CONTINUE
       ...
       320000-TOTALES-DE-CONTROL.
           ...
           DISPLAY '**************************************'.
           DISPLAY 'SUMA TOTAL: ' WSV-IMP-TOTAL.

           DISPLAY '**************************************'
           DISPLAY 'NUMERO DE CLIENTE =' WSV-NUMCLIEN
           DISPLAY '**************************************'.
